...
if selected_track_id:
    ...
    if track_data and audio_features:
        ...
        prediction_data = pd.DataFrame(columns=[
            ...
            'genres_Instrumental', 'genres_Jazz', 'genres_K-Pop', 'genres_Latin',
        ...
        st.write("Predicted Monthly Listeners:", predicted_monthly_listeners[0])
        st.write("Predicted Monthly Streams:", predicted_monthly_streams[0])
        st.write("Predicted Monthly Revenue:", predicted_monthly_revenue[0])
